...
const GuestTransportationCounter = () => {
  ...
  const userCount = () => {
    return guests.reduce((acc, guest) => {
      ...
      return acc + (shouldCount ? guest.guestTransportCount : 0);
    }, 0);
  };
  ...
  return (
    <div className="guest-counter">
      ...
      <div className="counter-display">
        ...
        <div className="count-label">Invitados que requeriran transporte</div>
      </div>
...
export default GuestTransportationCounter;
