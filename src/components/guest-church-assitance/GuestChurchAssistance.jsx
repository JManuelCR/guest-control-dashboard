...
import "./GuestChurchAssistance.css";

const GuestChurchAssistance = () => {
  ...
  const userCount = () => {
    return guests.reduce((acc, guest) => {
      ...
      guest.guestInvited === "YES" &&
        ...
        guest.guestChurchAssistantConfirmation &&
  ...
  return (
    <div className="guest-counter">
      <div className="counter-header">
        <h3>⛪ Contador de asistentes a la iglesia</h3>
        <div
      ...
      <div className="counter-display">
        ...
        <div className="count-label">Asistentes a la iglesia</div>
      </div>
...
export default GuestChurchAssistance;
